            ...
            modelBuilder.Entity("PrintManagement.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4938687b-e20e-4199-b2d0-8475ff2ee295"),
                            IsActive = true,
                            RoleCode = "Admin",
                        ...
                        new
                        {
                            Id = new Guid("4cec3911-8d7f-469d-a9b7-3efb49b88071"),
                            IsActive = true,
                            RoleCode = "Leader",
                            RoleName = "Người đứng đầu"
                        },
                        new
                        {
                            Id = new Guid("1e6fd561-9508-4ed7-86ba-f9bde4c27d68"),
                            IsActive = true,
                            RoleCode = "Designer",
                            RoleName = "Người thiết kế"
                        },
                        new
                        {
                            Id = new Guid("f40fcc24-d353-47b2-bf57-31611d8605ed"),
                            IsActive = true,
                            RoleCode = "Employee",
                            RoleName = "Nhân viên"
                        });
